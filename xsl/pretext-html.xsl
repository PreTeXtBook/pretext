...
<xsl:template match="worksheet" mode="page-margins-attribute">
    <xsl:attribute name="data-margins">
        ...
        <xsl:apply-templates select="." mode="worksheet-margin">
            ...
            <xsl:with-param name="pub-direction" select="$ws-margin-top"/>
        </xsl:apply-templates>
        <xsl:text> </xsl:text>
        <xsl:apply-templates select="." mode="worksheet-margin">
            <xsl:with-param name="direction" select="@right"/>
            <xsl:with-param name="pub-direction" select="$ws-margin-right"/>
        </xsl:apply-templates>
        <xsl:text> </xsl:text>
        <xsl:apply-templates select="." mode="worksheet-margin">
            <xsl:with-param name="direction" select="@bottom"/>
            <xsl:with-param name="pub-direction" select="$ws-margin-bottom"/>
        </xsl:apply-templates>
        <xsl:text> </xsl:text>
        <xsl:apply-templates select="." mode="worksheet-margin">
            <xsl:with-param name="direction" select="@left"/>
            <xsl:with-param name="pub-direction" select="$ws-margin-left"/>
        </xsl:apply-templates>
    </xsl:attribute>
</xsl:template>
