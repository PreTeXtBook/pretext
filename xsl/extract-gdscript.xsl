...
<!-- prepares a Python dictionary necessary to zip a -->
...
<!-- <xsl:template match="program[@language='gdscript' and @pck and @interactive='activecode']" mode="extraction"> -->
<xsl:template match="program[@pck]" mode="extraction">    
