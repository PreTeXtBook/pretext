...
<xsl:template match="node()|@*" mode="geogebra">
    <xsl:copy>
        <xsl:apply-templates select="node()|@*" mode="geogebra"/>
    </xsl:copy>
</xsl:template>
...
<xsl:variable name="geogebra-rtf">
    <xsl:apply-templates select="$assembly-label" mode="geogebra"/>
</xsl:variable>
<xsl:variable name="geogebra-revised" select="exsl:node-set($geogebra-rtf)"/>

<xsl:variable name="representations-rtf">
    <xsl:apply-templates select="$geogebra-revised" mode="representations"/>
</xsl:variable>
...
<xsl:template match="interactive[@geogebra]" mode="geogebra">
...
<xsl:template match="interative/@geogebra
                    ...
                    | interactive[@geogebra]/@material-height" mode="geogebra" />
