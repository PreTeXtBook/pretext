...
<xsl:variable name="icon-rtf">
    ...
    <iconinfo name="caret-right"
              font-awesome="caret-right"
              unicode="&#xf0da;"/> <!-- BLACK RIGHT-POINTING TRIANGLE -->
    <iconinfo name="caret-left"
              font-awesome="caret-left"
              unicode="&#xf0d9;"/> <!-- BLACK LEFT-POINTING TRIANGLE -->
    <iconinfo name="caret-up"
              font-awesome="caret-up"
              unicode="&#xf0d8;"/> <!-- BLACK UP-POINTING TRIANGLE -->
    <iconinfo name="caret-down"
              font-awesome="caret-down"
              unicode="&#xf0d7;"/> <!-- BLACK DOWN-POINTING TRIANGLE -->
    <iconinfo name="calculator"
              font-awesome="calculator"
              unicode="&#xf1ec;"/>
    <iconinfo name="info-circle"
              font-awesome="info-circle"
              unicode="&#xf05a;"/> <!-- i IN DARK CIRCLE -->
    <iconinfo name="user"
              font-awesome="user"
              unicode="&#xf007;"/> <!-- FIllED IN BUST -->
    <iconinfo name="edit"
              font-awesome="edit"
              unicode="&#xf044;"/> <!-- PENCIL WRITING ON PAPER -->
    <iconinfo name="search"
              font-awesome="search"
              unicode="&#xf002;"/> <!-- MAGNIFYING GLASS -->
