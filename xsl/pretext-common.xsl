...
<xsl:variable name="deprecation-max-age">
    <xsl:choose>
        ...
        <xsl:otherwise>
            ...
            <xsl:message>PTX:INFO:   checking the last 2 years of element deprecations. Rerun with '-x author.deprecations.all yes' stringparam to see all deprecations.</xsl:message>
        </xsl:otherwise>
    </xsl:choose>
</xsl:variable>
