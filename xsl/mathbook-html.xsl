...
<xsl:template match="fn|biblio|men|md|mdn|p|&EXAMPLE-LIKE;|&PROJECT-LIKE;|solution[not(ancestor::*[webwork])]|&THEOREM-LIKE;|proof|&AXIOM-LIKE;" mode="xref-knowl">
...
<xsl:template match="fn|biblio|p|&EXAMPLE-LIKE;|&PROJECT-LIKE;|solution[not(ancestor::*[webwork])]|&THEOREM-LIKE;|proof|&AXIOM-LIKE;">
...
<xsl:template match="list|remark|definition|exercise|hint|answer|exercisegroup|note|figure|table|listing|sidebyside|sidebyside/figure|sidebyside/table|contributor">
    <xsl:variable name="hidden">
...
<xsl:template match="list|remark|definition|exercise|exercise/hint|exercise/answer|exercise/solution|exercisegroup|note|figure|table|listing|sidebyside|sidebyside/figure|sidebyside/table|li|contributor" mode="xref-knowl">
    <xsl:variable name="knowl-file">
        <xsl:apply-templates select="." mode="xref-knowl-filename" />
    </xsl:variable>
    <exsl:document href="{$knowl-file}" method="html">
...
<xsl:template match="remark" mode="is-hidden-old">
...
<xsl:template match="definition" mode="is-hidden-old">
    <xsl:value-of select="$html.knowl.definition = 'yes'" />
</xsl:template>
<xsl:template match="definition" mode="is-block-env">
    <xsl:value-of select="true()" />
</xsl:template>
<!-- Knowl-text is an article with heading -->
<xsl:template match="definition" mode="hidden-knowl-text">
...
<!-- Head is type, number, title -->  <!-- GENERALIZE -->
<xsl:template match="definition" mode="head">
    <h5 class="heading">
        <span class="type"><xsl:apply-templates select="." mode="type-name" /></span>
        <span class="codenumber"><xsl:apply-templates select="." mode="number" /></span>
        <xsl:if test="title">
...
<xsl:template match="definition" mode="body">
    <xsl:apply-templates select="statement" />
    <xsl:apply-templates select="notation" />
</xsl:template>
<!-- No posterior  -->
<xsl:template match="definition" mode="posterior" />
<!-- HTML, CSS -->
<xsl:template match="definition" mode="environment-element">
    <xsl:text>article</xsl:text>
</xsl:template>
<xsl:template match="definition" mode="environment-class">
...
<xsl:template match="sidebyside" mode="is-hidden-old">
    <xsl:value-of select="$html.knowl.sidebyside = 'yes'" />
</xsl:template>
<xsl:template match="sidebyside/figure|sidebyside/table" mode="is-hidden-old">
    <xsl:value-of select="false()" />
</xsl:template>
...
<xsl:template match="hint|answer|solution|note" mode="is-hidden-old">
    <xsl:value-of select="true()" />
</xsl:template>
...
<xsl:template match="fn|p|biblio|note|&EXAMPLE-LIKE;|&PROJECT-LIKE;|list|remark|&THEOREM-LIKE;|proof|&AXIOM-LIKE;|definition|exercise|hint|answer|solution|exercisegroup|figure|table|listing|sidebyside|sidebyside/figure|sidebyside/table|men|mrow|li|contributor" mode="xref-as-knowl">
    <xsl:value-of select="true()" />
</xsl:template>
