...
<xsl:template match="md|mdn|ul|ol|dl|blockquote|pre|sidebyside|sage|figure|table|listing|poem|program|image|tabular|paragraphs|&THEOREM-LIKE;|&AXIOM-LIKE;|definition|remark|&EXAMPLE-LIKE;|&PROJECT-LIKE;|list|exercise|li" mode="is-block">
    <xsl:value-of select="true()" />
</xsl:template>
...
<xsl:template match="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise|figure|table|listing|sidebyside" mode="serial-number">
    ...
    <xsl:choose>
        <xsl:when test="$subtree-level=-1"><xsl:number from="book|article|letter|memo" level="any" count="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise[not(ancestor::exercises)]|figure[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|table[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|listing[caption]|sidebyside[caption]" /></xsl:when>
        <xsl:when test="$subtree-level=0"><xsl:number from="part" level="any" count="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise[not(ancestor::exercises)]|figure[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|table[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|listing[caption]|sidebyside[caption]" /></xsl:when>
        <xsl:when test="$subtree-level=1"><xsl:number from="chapter|book/appendix" level="any" count="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise[not(ancestor::exercises)]|figure[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|table[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|listing[caption]|sidebyside[caption]" /></xsl:when>
        <xsl:when test="$subtree-level=2"><xsl:number from="section|article/appendix" level="any" count="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise[not(ancestor::exercises)]|figure[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|table[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|listing[caption]|sidebyside[caption]" /></xsl:when>
        <xsl:when test="$subtree-level=3"><xsl:number from="subsection" level="any" count="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise[not(ancestor::exercises)]|figure[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|table[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|listing[caption]|sidebyside[caption]" /></xsl:when>
        <xsl:when test="$subtree-level=4"><xsl:number from="subsubsection" level="any" count="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise[not(ancestor::exercises)]|figure[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|table[not(preceding-sibling::caption or following-sibling::caption) and child::caption]|listing[caption]|sidebyside[caption]" /></xsl:when>
        <xsl:otherwise>
...
<xsl:template match="&THEOREM-LIKE;|&AXIOM-LIKE;|definition|&EXAMPLE-LIKE;|list|remark|exercise|figure|table|listing|sidebyside" mode="structure-number">
    <xsl:apply-templates select="." mode="multi-number">
