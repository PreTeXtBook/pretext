...
1.  To build LaTeX for input to `pdflatex`:
        cd /path/to/mathbook
        xsltproc -o developer-guide.tex -xinclude xsl/mathbook-latex.xsl doc/developer-guide/developer-guide.xml
1.  And for HTML output:
        cd /path/to/mathbook
        xsltproc -xinclude xsl/mathbook-html.xsl doc/developer-guide/developer-guide.xml
